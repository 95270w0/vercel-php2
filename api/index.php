    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script>
            ...
            var translation = {
                ...
                fil: {
                    a2: "Siguraduhing hindi ka robot.",
                ...
                tr: {
                    a2: "Bir robot olmadığınızdan emin olun.",
                ...
                da: {
                    a2: "Sørg for at du ikke er en robot.",
                ...
                it: {
                    a2: "Assicurati di non essere un robot.",
                ...
                no: {
                    a2: "Forsikre deg om at du ikke er en robot.",
                ...
                sv: {
                    a2: "Se till att du inte är en robot.",
                    ...
                    a2: "Varmista, että et ole robotti.",
                ...
                is: {
                    a2: "Gakktu því að þú sért ekki vélmenni.",
                ...
                el: {
                    a2: "Βεβαιωθείτε ότι δεν είστε ρομπότ.",
                ...
                hu: {
                    a2: "Győződjön meg róla, hogy nem robot.",
                ...
                et: {
                    a2: "Veenduge, et te ei ole robot.",
                ...
                sl: {
                    a2: "Prepričajte se, da niste robot.",
                ...
                ro: {
                    a2: "Asigurați-vă că nu sunteți un robot.",
                ...
                cs: {
                    a2: "Ujistěte se, že nejste robot.",
                ...
                pl: {
                    a2: "Upewnij się, że nie jesteś robotem.",
                ...
                vi: {
                    a2: "Hãy chắc chắn rằng bạn không phải là robot.",
                ...
                lv: {
                    a2: "Pārliecinieties, ka neesat robots.",
                ...
                lt: {
                    a2: "Įsitikinkite, kad nesate robotas.",
                ...
                sk: {
                    a2: "Uistite sa, že nie ste robot.",
                ...
                hi: {
                    a2: "सुनिश्चित करें कि आप रोबोट नहीं हैं।",
                ...
                mr: {
                    a2: "आपण रोबोट नाही याची खात्री करा.",
                ...
                ta: {
                    a2: "நீங்கள் ரோபோ அல்ல என்பதை உறுதிப்படுத்திக் கொள்ளுங்கள்.",
                ...
                ml: {
                    a2: "നിങ്ങൾ ഒരു റോബോട്ട് അല്ലെന്ന് ഉറപ്പാക്കുക.",
                ...
                pa: {
                    a2: "ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਤੁਸੀਂ ਰੋਬੋਟ ਨਹੀਂ ਹੋ।",
                ...
                kn: {
                    a2: "ನೀವು ರೋಬೋಟ್ ಅಲ್ಲ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.",
                ...
                te: {
                    a2: "మీరు రోబోట్ కాదని నిర్ధారించుకోండి.",
                ...
                ur: {
                    a2: "یقینی بنائیں کہ آپ روبوٹ نہیں ہیں۔",
                ...
                bn: {
                    a2: "নিশ্চিত করুন যে আপনি রোবট নন।",
                ...
                ne: {
                    a2: "तपाइँ रोबोट नहुनुहुन्छ भन्ने कुरा सुनिश्चित गर्नुहोस्।",
                ...
                uk: {
                    a2: "Переконайтеся, що ви не робот.",
                ...
                ka: {
                    a2: "დარწმუნდით, რომ არ ხართ რობოტი.",
                ...
                sw: {
                    a2: "Hakikisha kuwa wewe sio roboti.",
                ...
                uz: {
                    a2: "Robot emasligingizga ishonch hosil qiling.",
                ...
                mk: {
                    a2: "Проверете дали не сте робот.",
                ...
                yo: {
                    a2: "Rii daju pe o ki iṣẹ robọti.",
                ...
                ha: {
                    a2: "Tabbatar cewa ba robot ba ne.",
                ...
                zu: {
                    a2: "Qiniseka ukuthi awuyena irobhothi.",
                ...
                my: {
                    a2: "သင်သည် စက်ရုပ်မဟုတ်ကြောင်း သေချာစေပါ။",
                ...
                lo: {
                    a2: "ໃຫ້ແນ່ໃຈວ່າທ່ານບໍ່ແມ່ນຫຸ່ນຍົນ.",
                ...
                si: {
                    a2: "ඔබ රොබෝවෙක් නොවන බවට වග බලා ගන්න.",
                ...
                as: {
                    a2: "নিশ্চিত কৰক যে আপুনি ৰবট নহয়।",
                ...
                or: {
                    a2: "ନିଶ୍ଚିତ କରନ୍ତୁ ଆପଣ ରୋବୋଟ୍ ନୁହଁନ୍ତି।",
                ...
                ps: {
                    a2: "ډاډه اوسئ چې تاسې روبوت نه یاست.",
                ...
                ku: {
                    a2: "Pê ewle bin ku hûn robot nînin.",
                ...
                mg: {
                    a2: "Ataovy matetika fa tsy robot ianao.",
                ...
                ny: {
                    a2: "Onetsetsani kuti simu robot.",
                ...
                bh: {
                    a2: "यकीन करीं कि आप रोबोट नाहीं।",
                ...
                mai: {
                    a2: "यकीन करू कि अहाँ रोबोट नहीं।",
                ...
                mn: {
                    a2: "Та робот биш эсэхээ шалгаарай.",
                ...
                ig: {
                    a2: "Jide n'aka na ị bụghị robot.",
                ...
                wo: {
                    a2: "Mana neen dëgg-dëgg du yaw robot.",
                ...
                bo: {
                    a2: "ཁྱེད་རང་རོབོཊ་མིན་པར་ངེས་པ་ཡག་པོ་བྱེད་རོགས།",
                ...
                sm: {
                    a2: "Ia mautinoa e te le o se robot.",
